 ...
 */
public class HomeFramnt extends BaseFramnt  implements DefineView {
    ...
    public List<HomeFramtInfoBen.Datali.Autoli> data=null;
    private HomeFramtInfoBen homeFramtInfoBen=null;
    ...
    private List<BannerBen> bannerBens=null;

    private List<Techli> tech=null;
...
//    list.add(new ImageCycleView.ImageInfo("http://www.3dmgame.com/uploads/allimg/130124/1111111111111111111111111111111-130124145R1-50.jpg", "1月31日3DM新游评测与推荐 老司机是时候开车了", "3545703"));
    ...
    public static HomeFramnt newInstance( CateBen titlelist) {
        Bundle args = new Bundle();
        args.putSerializable(KEY,titlelist);
        HomeFramnt pageFramnt = new HomeFramnt();
    ...
    public void initData() {
      ...
      // bannerList.add("http://www.3dmgame.com/uploads/allimg/130124/1111111111111111111111111111111-130124145R1-50.jpg");
        ...
        OkhttpManager.getAsync(mess.getUrl(), new OkhttpManager.DataCallBack() {
            ...
            public List<HomeFramtInfoBen.Datali.Dyli> dy=null;
...
//                List<Techli> tech = ;
                ...
                //推荐 = homeFramtInfoBen.get推荐();
                 dy = homeFramtInfoBen.getData().getDy();
                int size = dy.size();
    ...
    private  HomeFramtInfoBen parse_json(String result) {
         homeFramtInfoBen = JSON.parseObject(result, HomeFramtInfoBen.class);
