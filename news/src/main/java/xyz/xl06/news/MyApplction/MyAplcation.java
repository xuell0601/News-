package xyz.xl06.news.MyApplction;
...
public class MyAplcation   extends Application{
    private static MyAplcation instance=null;
    @Override
    public void onCreate() {
        super.onCreate();
        this.instance=this;
        LeakCanary.install(this);
        Bmob.initialize(this, "97b6172e25f63d8447aad05b67b00629");
        MobSDK.init(this);
        //统计
        UMConfigure.init(this, UMConfigure.DEVICE_TYPE_PHONE, "");
        MobclickAgent.setScenarioType(this, MobclickAgent.EScenarioType.E_UM_NORMAL);//选择统计模式
        UMConfigure.setLogEnabled(true);//开启调试
//在使用SDK各组件之前初始化context信息，传入ApplicationContext
    ...
    public static MyAplcation getInstance(){
        return instance;
    }
